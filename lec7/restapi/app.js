...
// note:-
// urlencoded means we can send value along with url or with the help of url we can send value
// urlencoded is used to send value to backend with the help of url