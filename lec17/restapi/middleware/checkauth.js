...
module.exports=(req,res,next)=>{
    ...
    console.log(token)
    const verify=jwt.verify(token,"this is dummy key") //this verifies whether the token is of the registered user or not
    console.log(verify) //this will return data like jwt.io 
